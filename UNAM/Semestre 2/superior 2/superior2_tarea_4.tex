...
\begin{proof}\,\\
    \,\\
    Procedemos por contradicci\'on es decir $\delta\,f_1\neq\delta\,f_2\neq\delta\,f_3\neq\delta\,f_4$, como $\delta\,f_i\geq 1$, para $i=1,2,3,4$, es claro que
    podemos suponer que $\delta f_1<\delta f_2<\delta f_3<\delta f_4$, por tanto $1=\delta f_1$, $2=\delta f_2$, $3=\delta f_3$, $4=\delta f_4$, y por tanto $10=1+2+3+4=\delta f_1+\delta f_2+\delta f_3+\delta f_4=5$ una contradicci\'on
\end{proof}\,\\
\begin{tcolorbox}[
