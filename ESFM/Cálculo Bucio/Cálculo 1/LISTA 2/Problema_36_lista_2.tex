...
\begin{itemize}
    \item Demuestre que $\displaystyle\sum_{n=1}^{\infty}\,\frac{1}{n^2}$ converge, hint:\,\,$\displaystyle \sum_{n=1}^{\infty}\,\frac{1}{n(n+1)}$\,\,converge
    ...
    \end{equation*}
    \item Pruebe que para todo $n\geq 0$:\,\\
    \begin{equation*}
        f_{n+1}=\sum_{k=0}^{\lfloor \frac{n}{2} \rfloor }\binom{n-k}{k}
    \end{equation*}
    \item Finalmente deduzca que:\,\\
    \begin{equation*}
        \phi=\lim_{n\rightarrow \infty}\,\frac{\displaystyle\sum_{k=0}^{n-1}\binom{2n-1-k}{k}}{\displaystyle\sum_{k=0}^{n-1}\binom{2n-2-k}{k}}
    \end{equation*}
\end{itemize}}
\end{tcolorbox}
\begin{proof}\,\\
