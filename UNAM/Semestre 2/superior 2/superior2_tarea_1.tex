...
\begin{proof}\,\\
    ...
    \,\\
    \begin{equation*}
        \sum_{n=0}^{\infty}\,a_n\,x^n\,\odot \sum_{n=0}^{\infty}\,b_n\,x^n=\sum_{n=0}^{\infty}\,\sum_{k+l=n}\,a_k\,b_l\,x^n
    \end{equation*}\,\\
    Expandiendo esta serie de potencias y reescribiendo a $\bar{1}$ en su forma de serie de potencia:\,\\
    \,\\
    \begin{equation*}
        \sum_{n=0}^{\infty}\,a_n\,x^n\,\odot \sum_{n=0}^{\infty}\,b_n\,x^n=a_0b_0+\sum_{n=1}^{\infty}\,\sum_{k+l=n}\,a_k\,b_l\,x^n=1+\sum_{n=0}^{\infty}\,0\,x^n
    \end{equation*}\,\\
    Como dos series de potencias son iguales si y solo si todos sus terminos son iguales:\,\\
    \,\\
    \begin{equation*}
        a_0b_0=1\,\,\,\,\,y\,\,\,\,\,0=\sum_{n=1}^{\infty}\,\sum_{k+l=n}\,a_k\,b_l\,x^n
    \end{equation*}\,\\
    \,\\
