   ...
   \end{equation*}
    ...
    \begin{align*}
        p\circ W(x,y,z)=\overline{x}^t \begin{pmatrix}
                ...
                \,\\
                =x^2+\frac{x}{\sqrt{2}}+\frac{1}{4(2)}-y^2+\frac{y}{\sqrt{2}}-\frac{1}{4(2)}-z-\frac{5}{\sqrt{2}}=\left(x+\frac{1}{2\,\sqrt{2}}\right)^2-\left(y-\frac{1}{2\,\sqrt{2}}\right)^2-\left(z+\frac{5}{\sqrt{2}}\right)
    \end{align*}\,\\
    \newpage
